namespace Codewars
{
     ...
     * calculates the area covered by a union of rectangles.
     * 
     * Rectangles can have non-empty intersection, in this way simple solutions
     * will not work.
     * 
     * Preconditions
     * 
     ...
     * Requirements
     * 
     * - Number of rectangles in one test (not including simple tests) range from
     *   3000 to 15000. There are 10 tests with such range. So, your algorithm 
     *   should be optimal.
     ...
     * - R1 and R2 are overlapping (2x2), the grayed area is removed from the 
     *   total area
     * 
